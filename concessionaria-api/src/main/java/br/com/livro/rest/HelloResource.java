...
public class HelloResource {
	@GET
	@Consumes(MediaType.TEXT_HTML)                                // <-- (CONSUMES) DEFINE O TIPO DE CONTEUDO
	@Produces(MediaType.TEXT_HTML + ";charset=utf-8")             // <-- (PRODUCES) DEFINE O TIPO DE CONTEUDO QUE O METODO RETORNA
